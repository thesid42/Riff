...
- Creative previews use a flat three-column layout with one action row per version. Campaign and experiment controls share readable labels and consistent sizing. Audience configuration opens at one level, with run settings next to the primary action; secondary details use dividers and spacing instead of nested cards and accordions.
